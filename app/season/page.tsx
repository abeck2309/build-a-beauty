...
export default async function SeasonPage({ searchParams }: { searchParams: Promise<{ team?: string; overall?: string; position?: string; archetype?: string; off?: string; pas?: string; acc?: string; pow?: string; dek?: string; def?: string; spd?: string }> }) {
